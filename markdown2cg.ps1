...
.statement-icon_statement_examples {
    background-image: url('https://static.codingame.com/assets/spritesheets/statement.8f64ade5.png');
...
.statement-icon_statement_expert_rules {
    background-image: url('https://static.codingame.com/assets/spritesheets/statement.8f64ade5.png');
...
.statement-icon_statement_lose_conditions {
    background-image: url('https://static.codingame.com/assets/spritesheets/statement.8f64ade5.png');
...
.statement-icon_statement_protocol {
    background-image: url('https://static.codingame.com/assets/spritesheets/statement.8f64ade5.png');
...
.statement-icon_statement_pseudo_code_algorithm {
    background-image: url('https://static.codingame.com/assets/spritesheets/statement.8f64ade5.png');
...
.statement-icon_statement_rules {
    background-image: url('https://static.codingame.com/assets/spritesheets/statement.8f64ade5.png');
...
.statement-icon_statement_victory_conditions {
    background-image: url('https://static.codingame.com/assets/spritesheets/statement.8f64ade5.png');
...
.statement-icon_statement_warning {
    background-image: url('https://static.codingame.com/assets/spritesheets/statement.8f64ade5.png');
...
.marked a, .marked a:active, .marked a:hover, .marked a:visited {
    transition: color 0.2s ease-in-out;
    border-bottom: none;
}

.marked a, .marked a:active, .marked a:visited {
    color: #1a99aa;
}

.marked a:hover {
    color: rgba(26, 153, 170, .8);
}
...
.marked table, .marked td, .marked th {
...
.statement_content.retroStatement {
    overflow-y: initial;
}
...
a, a:active, a:hover, a:visited {
    color: #454c55;
    border-bottom: 1px dotted #454c55;
}
...
.protocol .protocol_title:first-of-type {
    margin-top: 0;
}
...
.protocol .initNText, .protocol .loopNText {
    display: inline;
}
...
.example .example_presentation_container {
    display: block;
    padding-left: 20px;
    padding-right: 20px;
    overflow-x: auto;
...
.example .example_presentation_container .example_presentation {
    background-color: #fff;
    display: table;
    width: 100%;
}

.example .example_presentation_container .example_presentation .illustration_wrapper {
    display: table-cell;
    vertical-align: middle;
}

.example .example_presentation_container .example_presentation .illustration {
    width: 100%;
    display: block;
}

.example .example_presentation_container .example_presentation .text {
    background: #454c55;
    padding: 20px;
    text-align: center;
    display: table-cell;
...
.example .example_rounds .round_container {
    margin-top: 20px;
    flex: 1;
    -webkit-flex: 1;
    -ms-flex: 1;
...
.example .example_rounds .round .illustration {
    width: 100%;
}

.example .example_rounds .round .text {
    word-wrap: break-word;
    padding: 15px;
    color: #fff;
}

.example .example_rounds .round .round_title {
    text-transform: uppercase;
    display: block;
    font-weight: 700;
    color: #f2bb13;
...
.example .example_conclusion_container {
    display: block;
    padding-left: 20px;
    padding-right: 20px;
    margin-top: 10px;
...
.example .example_conclusion_container .example_conclusion {
...
.example .example_conclusion_container .example_conclusion .text {
    text-transform: uppercase;
    display: table-cell;
    vertical-align: middle;
    text-align: center;
...
.question-statement-example-in, .question-statement-example-out {
    white-space: pre;
}
...
.statement-body h1, .statement-body h2 {
    color: #838891;
    font-size: 14px;
    font-weight: 700;
    margin-bottom: 15px;
...
.statement-body h1 .icon.icon-rules, .statement-body h2 .icon.icon-rules {
    background-image: url('https://static.codingame.com/assets/spritesheets/statement.8f64ade5.png');
    background-position: -70px 0;
    width: 20px;
    height: 20px;
...
.statement-body h1 .icon.icon-expertrules, .statement-body h2 .icon.icon-expertrules {
    background-image: url('https://static.codingame.com/assets/spritesheets/statement.8f64ade5.png');
    background-position: -50px 0;
    width: 20px;
    height: 20px;
...
.statement-body h1 .icon.icon-pseudocode, .statement-body h2 .icon.icon-pseudocode {
    background-image: url('https://static.codingame.com/assets/spritesheets/statement.8f64ade5.png');
    background-position: -40px -45px;
    width: 20px;
    height: 20px;
...
.statement-body h1 .icon.icon-warning, .statement-body h2 .icon.icon-warning {
    background-image: url('https://static.codingame.com/assets/spritesheets/statement.8f64ade5.png');
    background-position: -70px -20px;
    width: 20px;
    height: 20px;
...
.statement-body h1 .icon.icon-protocol, .statement-body h2 .icon.icon-protocol {
    background-image: url('https://static.codingame.com/assets/spritesheets/statement.8f64ade5.png');
    background-position: -20px -45px;
    width: 20px;
    height: 20px;
...
.statement-body h1 .icon.icon-example, .statement-body h2 .icon.icon-example {
    background-image: url('https://static.codingame.com/assets/spritesheets/statement.8f64ade5.png');
    background-position: -20px -25px;
    width: 20px;
    height: 20px;
...
.statement-body h1 .icon.icon-hint, .statement-body h2 .icon.icon-hint {
    background-image: url('https://static.codingame.com/assets/spritesheets/statement.8f64ade5.png');
    background-position: 0 -45px;
    width: 20px;
    height: 20px;
...
.statement-body h1 span, .statement-body h2 span {
    display: table-cell;
    vertical-align: middle;
}

.statement-body span.var, .statement-body var {
    font-size: 12px;
    padding: 1px 4px;
...
.statement-body const, .statement-body span.const {
    color: #18a1ea;
    padding-left: 2px;
    padding-right: 2px;
    padding-top: 2px;
...
.statement-body .statement-protocol .title {
    font-size: 14px;
    font-weight: 700;
    padding-top: 5px;
    padding-bottom: 15px;
...
.statement-body .statement-protocol .blk {
    border-bottom: 1px solid #dadada;
    padding-top: 15px;
    padding-bottom: 15px;
}

.statement-body .statement-protocol .blk:last-child {
    border-bottom: none!important;
    padding-bottom: 0;
}

.statement-body .statement-protocol .blk:first-of-type {
    padding-top: 0;
}

.statement-body .statement-lineno {
    color: #838891;
    font-weight: 700;
}

.statement-body .statement-victory-conditions {
    color: #1a99aa;
    background-color: rgba(26, 153, 170, .1);
    padding: 20px;
    margin-top: 10px;
    display: -webkit-flex;
    display: flex;
...
.statement-body .statement-victory-conditions .icon {
    vertical-align: middle;
    text-align: center;
    margin-left: 8px;
    margin-right: 25px;
...
.statement-body .statement-victory-conditions .blk {
    vertical-align: middle;
}

.statement-body .statement-victory-conditions .title {
    font-weight: 700;
    margin-bottom: 10px;
}

.statement-body .statement-lose-conditions {
    color: #f85338;
    background-color: rgba(248, 83, 56, .1);
    padding: 20px;
    margin-top: 10px;
    display: -webkit-flex;
    display: flex;
...
.statement-body .statement-lose-conditions .icon {
    vertical-align: middle;
    text-align: center;
    margin-left: 8px;
    margin-right: 25px;
...
.statement-body .statement-lose-conditions .blk {
    vertical-align: middle;
}

.statement-body .statement-lose-conditions .title {
    font-weight: 700;
    margin-bottom: 10px;
}
...
.statement-body .statement-story {
    top: 0;
    left: 0;
    height: 100%;
    width: 100%;
    padding: 30px 15px;
    background-color: rgba(69, 76, 85, .8);
    text-align: justify;
    color: #fff;
}

.statement-body .statement-story h1 {
    font-weight: 700;
    margin-top: 0;
    color: #fff;
}

.statement-body .statement-inout {
    display: -webkit-flex;
    display: flex;
    width: calc(100% + 10px);
    margin-left: -5px;
...
.statement-body .statement-inout .statement-inout-in, .statement-body .statement-inout .statement-inout-out {
    -webkit-flex: 1;
    flex: 1;
...
.statement-body .statement-inout .statement-inout-in pre, .statement-body .statement-inout .statement-inout-out pre {
    scrollbar-color: rgba(0, 0, 0, .2) transparent;
    scrollbar-width: thin;
}

.statement-body .statement-inout .statement-inout-in pre::-webkit-scrollbar, .statement-body .statement-inout .statement-inout-out pre::-webkit-scrollbar {
    width: 14px;
    height: 14px;
    background-color: transparent;
}

.statement-body .statement-inout .statement-inout-in pre::-webkit-scrollbar-thumb, .statement-body .statement-inout .statement-inout-out pre::-webkit-scrollbar-thumb {
    min-height: 40px;
    border: 4px solid transparent;
    background-clip: padding-box;
    -webkit-border-radius: 7px;
...
.statement-body .statement-inout .statement-inout-in pre::-webkit-scrollbar-corner, .statement-body .statement-inout .statement-inout-out pre::-webkit-scrollbar-corner {
    background: transparent;
}

.statement-body .statement-inout .statement-inout-in .title, .statement-body .statement-inout .statement-inout-out .title {
    font-weight: 700;
    margin-bottom: 10px;
    padding: 0;
    color: #838891;
...
.statement-body .statement-inout pre {
    border: none;
    background-color: transparent;
...
.statement-body .statement-example-container {
    display: -webkit-flex;
    display: flex;
...
.statement-body .statement-example {
    display: inline-block;
    width: 260px;
    max-width: 300px;
...
.statement-body .statement-example .legend {
    color: #454c55;
    padding: 15px;
    height: 90px;
    display: block;
...
.statement-body .statement-example .title {
    font-weight: 700;
}

.statement-body .statement-example img {
    background-color: #454c55;
    width: 100%;
    display: block;
}

.statement-body .statement-example.statement-example-empty, .statement-body .statement-example:empty {
    margin-top: 0;
    margin-bottom: 0;
    height: 0;
}

.statement-body .statement-example.statement-example-medium {
    -webkit-flex-basis: 190px;
    flex-basis: 190px;
    width: 190px;
}

.statement-body .statement-example.statement-example-small {
    -webkit-flex-basis: 140px;
    flex-basis: 140px;
    width: 140px;
}

.statement-body .statement-example-horizontal {
    width: 100%;
    margin-top: 10px;
    margin-bottom: 10px;
    background-color: #e7e9eb;
...
.statement-body .statement-example-horizontal .header {
    width: 270px;
    display: table-cell;
    background-color: transparent;
    vertical-align: middle;
...
.statement-body .statement-example-horizontal .legend {
    color: #454c55;
    display: table-cell;
    vertical-align: middle;
...
.statement-body .statement-example-horizontal .title {
    font-weight: 700;
}

.statement-body .statement-example-horizontal img {
    background-color: #454c55;
    display: block;
}

.statement-body .statement-new-league-rule {
    padding-left: 10px;
    border-left: 5px solid #7cc576;
    margin-left: -15px;
    background: rgba(124, 197, 118, .1);
    margin-right: -15px;
    padding-right: 10px;
}

.statement-body .statement-summary-new-league-rules {
    color: #7cc576;
...
.statement-body .statement-summary-new-league-rules .statement-summary-new-league-rules-logo {
    text-align: center;
    margin-bottom: 6px;
}

.statement-body .statement-summary-new-league-rules .statement-summary-new-league-rules-title {
    text-align: center;
    font-weight: 700;
    margin-bottom: 6px;
}

.hide-protocol .statement-protocol {
    display: none;
}

.hide-protocol .statement-goal {
    margin-bottom: 0;
}
...
.statement-body .statement-victory-conditions {
    background-color: rgba(26, 153, 170, .15);
}

.statement-body .statement-lose-conditions {
    background-color: rgba(248, 83, 56, .15);
}
...
.statement-body .statement-example .legend, .statement-body .statement-example-horizontal .legend {
    color: #fff;
    background-color: #363e48;
}
...
.statement-body .statement-inout-in, .statement-body .statement-inout-out {
    background-color: #454c55!important;
    color: #fff;
}

.statement-body .statement-inout-in pre, .statement-body .statement-inout-out pre {
    scrollbar-color: hsla(0, 0%, 100%, .2) transparent;
    scrollbar-width: thin;
}

.statement-body .statement-inout-in pre::-webkit-scrollbar, .statement-body .statement-inout-out pre::-webkit-scrollbar {
    width: 14px;
    height: 14px;
    background-color: transparent;
}

.statement-body .statement-inout-in pre::-webkit-scrollbar-thumb, .statement-body .statement-inout-out pre::-webkit-scrollbar-thumb {
    min-height: 40px;
    border: 4px solid transparent;
    background-clip: padding-box;
    -webkit-border-radius: 7px;
...
.statement-body .statement-inout-in pre::-webkit-scrollbar-corner, .statement-body .statement-inout-out pre::-webkit-scrollbar-corner {
    background: transparent;
}
